...
python evaluation.py -task=random -eval_mode=sel_sent -device=cuda:3 
python evaluation.py -task=random -eval_mode=rm_sent -device=cuda:3  
python evaluation.py -task=lead -eval_mode=sel_sent -device=cuda:3  
python evaluation.py -task=lead -eval_mode=rm_sent -device=cuda:3  